...
def portal_public_url(*, hosted: str, custom: str = "", custom_verified: bool = False) -> str:
    ...
    scheme = "https" if custom and custom_verified else settings.CHATBALLS_HELP_PUBLIC_SCHEME
    port = "" if custom and custom_verified else settings.CHATBALLS_HELP_PUBLIC_PORT
