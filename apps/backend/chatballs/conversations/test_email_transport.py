...
class EmailNormalizeTests(TestCase):
    ...
    def test_plain_message_becomes_inbound_with_thread_meta(self) -> None:
        ...
        inbound, message_id = email_transport._normalize(
            ...
            _parsed(_raw()), own_address="support@example.com", fallback_id="7:100"
    ...
    def test_own_message_is_skipped(self) -> None:
        ...
        inbound, _ = email_transport._normalize(
            ...
            _parsed(_raw(from_="support@example.com")), own_address="support@example.com", fallback_id="7:100"
    ...
    def test_attachments_become_inbound_files(self) -> None:
        ...
        inbound, _ = email_transport._normalize(
            ...
            _parsed(_raw(attach=True)), own_address="support@example.com", fallback_id="7:100"
    ...
    def test_missing_message_id_falls_back_to_uid(self) -> None:
        ...
        inbound, _ = email_transport._normalize(
            ...
            _parsed(_raw(message_id="")), own_address="support@example.com", fallback_id="7:100"
...
class EmailSendTests(TestCase):
    ...
    def test_reply_goes_into_the_same_thread(self) -> None:
        ...
        smtp.login.assert_called_once_with("support@example.com", "app-password")
